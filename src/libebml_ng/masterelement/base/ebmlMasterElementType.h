...
//     };
     ...
     *
     * This class provides the fundamental structure and functionality for EBML elements that can contain other elements.
     * It is not meant to be instantiated directly but serves as a base class for concrete master element types like
     * `ebml::ebmlListType` and `ebml::ebmlStructType`.
     */
    ...
    // class ebmlMasterElement : public ebmlElementTmpl<ebmlMasterElementType, ebmlMasterElement> {
    // class ebmlMasterElement : public InstMixin<ebmlMasterElementType, ebmlMasterElement> {
    //     // Constructors
    // protected:
