...
namespace ebml {
    template class ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement, ebmlElementType>;
    ...
    ebmlMasterElementType::ebmlMasterElementType(const char* ebmlID, const std::wstring& name, const childTypeSpecArg_l & childTypes)
    : ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement>(ebmlID, name), _childTypes(childTypes) {}

    ebmlMasterElementType::ebmlMasterElementType(ebmlID_t ebmlID, const std::wstring& name, const childTypeSpecArg_l & childTypes)
    : ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement>(ebmlID, name), _childTypes(childTypes) {}

    ebmlMasterElementType::ebmlMasterElementType(const char* ebmlID, const std::wstring& name, const childTypeSpecArg_l & childTypes, const seekHelper_t* seekHelper)
    : ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement>(ebmlID, name, seekHelper), _childTypes(childTypes) {}

    ebmlMasterElementType::ebmlMasterElementType(ebmlID_t ebmlID, const std::wstring& name, const childTypeSpecArg_l & childTypes, const seekHelper_t* seekHelper)
    : ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement>(ebmlID, name, seekHelper), _childTypes(childTypes) {}

    ebmlMasterElementType::ebmlMasterElementType(const char* ebmlID, const std::wstring& name)
    : ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement>(ebmlID, name) {}

    ebmlMasterElementType::ebmlMasterElementType(ebmlID_t ebmlID, const std::wstring& name)
    : ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement>(ebmlID, name) {}

    ebmlMasterElementType::ebmlMasterElementType(const char* ebmlID, const std::wstring& name, const seekHelper_t* seekHelper)
    : ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement>(ebmlID, name, seekHelper) {}

    ebmlMasterElementType::ebmlMasterElementType(ebmlID_t ebmlID, const std::wstring& name, const seekHelper_t* seekHelper)
    : ebmlTypeCRTP<ebmlMasterElementType, ebmlMasterElement>(ebmlID, name, seekHelper) {}

    // // *** class ebmlMasterElement ***
    //
    // ebmlMasterElement::ebmlMasterElement(const ebmlMasterElementType* cls) : InstMixin<ebmlMasterElementType, ebmlMasterElement>(cls) {}
    //
