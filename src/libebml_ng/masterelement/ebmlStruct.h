...
namespace ebml {
    // Slot specification to be stored in ebmlMultiSlotType.
     ...
     * @brief Represents a structure-like EBML master element.
     *
     * This class defines an EBML element type that acts as a structure or record, containing a fixed set of named
     * children. It provides a way to enforce a specific schema or structure within the EBML document.
     */
    class ebmlStructType : public ebmlTypeCRTP<ebmlStructType, ebmlStruct, ebmlMasterElementType> {
    ...
    class ebmlStruct : public ebmlElementCRTP<ebmlStructType, ebmlStruct, ebmlMasterElement> {
    private:
    ...
    protected:
        ...
        private:
            ebml::ptr<const ebmlStruct> _elem;
    ...
    protected:
        ...
        friend class ebmlTypeCRTP<ebmlStructType, ebmlStruct, ebmlMasterElementType>;
        friend class ebmlElementCRTP<ebmlStructType, ebmlStruct, ebmlMasterElement>;
        friend class slot_t;
    };

    extern template class ebmlTypeCRTP<ebmlStructType, ebmlStruct, ebmlMasterElementType>;
    extern template class ebmlElementCRTP<ebmlStructType, ebmlStruct, ebmlMasterElement>;
    extern template class flexible_ptr<ebmlStruct>;
    extern template class ebml_shared_ptr<ebmlStruct>;
    extern template class ebml_weak_ptr<ebmlStruct>;
}
#endif
