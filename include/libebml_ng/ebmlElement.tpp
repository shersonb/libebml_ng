...
namespace ebml {
    ...
    const ebmltype_t& InstMixin<ebmltype_t, ebmlinst_t, instbase_t>::cls() const {
        return *static_cast<const ebmltype_t*>(this->_cls);
    }

    template<typename ebmltype_t, typename ebmlinst_t, typename instbase_t>
    ebmlElement* InstMixin<ebmltype_t, ebmlinst_t, instbase_t>::_clone() const {
    ...
    template<typename ebmltype_t, typename ebmlinst_t, typename instbase_t>
    ebml::ptr<ebmlinst_t> InstMixin<ebmltype_t, ebmlinst_t, instbase_t>::sp() {
        return this->_self.template lock<ebmlinst_t>();
    }

    template<typename ebmltype_t, typename ebmlinst_t, typename instbase_t>
    ebml::ptr<const ebmlinst_t> InstMixin<ebmltype_t, ebmlinst_t, instbase_t>::sp() const {
        return this->_self.template lock<const ebmlinst_t>();
    }

    template<typename ebmltype_t, typename ebmlinst_t, typename instbase_t>
    ebml::wptr<ebmlinst_t> InstMixin<ebmltype_t, ebmlinst_t, instbase_t>::wp() {
        return ebml_static_pointer_cast<ebmlinst_t>(this->_self);
    }

    template<typename ebmltype_t, typename ebmlinst_t, typename instbase_t>
    ebml::wptr<const ebmlinst_t> InstMixin<ebmltype_t, ebmlinst_t, instbase_t>::wp() const {
        return ebml_static_pointer_cast<const ebmlinst_t>(this->_self);
    }

    template<typename ebmltype_t, typename ebmlinst_t, typename instbase_t>
    ebml::ptr<ebmlinst_t> InstMixin<ebmltype_t, ebmlinst_t, instbase_t>::clone() const {
        auto clone = _clone();
