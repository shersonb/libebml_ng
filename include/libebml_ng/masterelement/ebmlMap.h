...
namespace ebml {
    ...
    >
    class ebmlMapClass : public ClsMixin<ebmlMapClass<K, V, H, E, A, B>, ebmlMap<K, V, H, E, A, B>, ebmlMasterElementClass> {
    public:
        ebmlMapClass(const char*, const std::wstring&, const ebmlPairClass<const K, V>* paircls);
        ebmlMapClass(ebmlID_t, const std::wstring&, const ebmlPairClass<const K, V>* paircls);
        const ebmlPairClass<const K, V>& paircls() const;

    private:
        const ebmlPairClass<const K, V>* _paircls;
    ...
    class ebmlMap : public InstMixin<ebmlMapClass<K, V, H, E, A, B>, ebmlMap<K, V, H, E, A, B>, ebmlMasterElement> {
        friend class ClsMixin<ebmlMapClass<K, V, H, E, A, B>, ebmlMap<K, V, H, E, A, B>, ebmlMasterElementClass>;
        friend class InstMixin<ebmlMapClass<K, V, H, E, A, B>, ebmlMap<K, V, H, E, A, B>, ebmlMasterElement>;

    private:
        ebmlMapData<K, V, H, E, A> _data;

    protected:
        ebmlMap(const ebmlMapClass<K, V, H, E, A, B>*);
        ebmlMap(const ebmlMapClass<K, V, H, E, A, B>*, const std::vector<std::pair<K, pair_value_t<V>>>&);
        ebmlMap(const ebmlMapClass<K, V, H, E, A, B>*, std::vector<std::pair<K, pair_value_t<V>>>&&);
        ebmlMap(const ebmlMapClass<K, V, H, E, A, B>*, const ebmlMapArgs<K, V, H, E, B>&);
        ebmlMap(const ebmlMapClass<K, V, H, E, A, B>*, ebmlMapArgs<K, V, H, E, B>&&);
